...
var taskInput=document.querySelector(".task-add__text-input");//Add a new task.
var addButton=document.querySelector(".task-add__add-btn");//first button
var incompleteTaskHolder=document.querySelector(".incompleted-tasks .task-list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".completed-tasks .task-list");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="task__edit-btn button";

    deleteButton.className="task__delete-btn button button_delete";
